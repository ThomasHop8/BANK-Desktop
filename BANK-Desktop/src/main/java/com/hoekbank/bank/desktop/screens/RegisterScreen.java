...
public class RegisterScreen extends RegisterScreenUI {
    ...
    public RegisterScreen(GridPane root) {
        ...
        registerButton.setOnAction(event -> {
           ...
           else if (txttelefoon.getText().contains("\\d+")) {
                Alert alert = new Alert(AlertType.INFORMATION);
                alert.setTitle("Foutmelding");
                alert.setHeaderText("LET OP!");
            ...
            else  if (txtstraatnaam.getText().contains("[^A-Za-z ]")) {
                Alert alert = new Alert(AlertType.INFORMATION);
                alert.setTitle("Foutmelding");
                alert.setHeaderText("LET OP!");
            ...
            else  if (txthuisnummer.getText().contains("[0-9]")) {
                Alert alert = new Alert(AlertType.INFORMATION);
                alert.setTitle("Foutmelding");
                alert.setHeaderText("LET OP!");
                alert.setContentText("Vul aub een geldig telefoonnummer in in");
            ...
            else  if (!txtwoonplaats.getText().contains("[^A-Za-z ]")) {
                Alert alert = new Alert(AlertType.INFORMATION);
                alert.setTitle("Foutmelding");
                alert.setHeaderText("LET OP!");
          ...
          else  if (!txtpostcode.getText().contains("[A-Z]") && !txtpostcode.getText().contains("[0-9]")) {
                Alert alert = new Alert(AlertType.INFORMATION);
                alert.setTitle("Foutmelding");
                alert.setHeaderText("LET OP!");
                alert.setContentText("Vul aub een geldige woonplaats in in");
